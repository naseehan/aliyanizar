...
const Footer = () => {
  return (
    ...
    <div className="flex justify-center items-center gap-[30px]">
      <img src={icon1} alt="dribble"  loading="lazy"  className="cursor-pointer"/>
      <img src={icon2} alt="instagram"  loading="lazy" className="cursor-pointer"/>
      <img src={icon3} alt="linkedin"  loading="lazy" className="cursor-pointer"/>
      <img src={icon4} alt="behance" loading="lazy"  className="cursor-pointer"/>
    </div>
